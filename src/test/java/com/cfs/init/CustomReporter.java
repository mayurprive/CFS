...
public class CustomReporter extends CustomReporterListener {
	...
	protected PrintWriter createWriter(String outdir) throws IOException {
		...
		return new PrintWriter(
				new BufferedWriter(new FileWriter(new File(outdir, "KiwiQA-Customize-Report" + ".html"))));
	}
	...
	public void testCaseNo() {
		...
		m_out.println(
				"<td bgcolor='#99CCFF' colspan='4' align='left' height='30px'><h3 style='margin-top:0px;margin-bottom:0px;'> Total Test Cases  : "
						+ (failedCounter + passed) + "</br> Failed Test Cases  : " + (failedCounter)
						+ "</br> Passed Test cases : " + passed + "</br></h3></td>");
	...
	private void resultSummary(ISuite suite, IResultMap tests, String testname, String style, String details) {
		...
		if (tests.getAllResults().size() > 0) {
			...
			for (ITestNGMethod method : getMethodSet(tests, suite)) {
				...
				m_out.println("<td class=\"numi\"><center>" + (end - start) / 1000 + "</center></td>" + "</tr>");
	...
	private void startResultSummaryTable(String style) {
		...
		// href=\"http://52.0.218.82:8080/job/dev2_Pley_Chrome/HTML_Report/\">http://52.0.218.82:8080/job/dev2_Pley_Chrome/HTML_Report</a></td></tr>");
		m_out.println("<tr><td colspan='4'>Overall test suite completion : <b>" + Time
				+ " minutes</b></br> Date and Time of Run: <b>" + sdf.format(date) + "</b></br> Browser Name : <b>"
				+ SeleniumInit.browserName + "</b></br> Browser Version: <b>" + SeleniumInit.browserVersion
				+ "</b> </br>OS: <b>" + SeleniumInit.osName + "</b></td></tr>");
