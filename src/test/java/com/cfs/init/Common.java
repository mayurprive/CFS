...
public class Common {
	 ...
	 */
	public static void openMailinator(WebDriver driver, String emailAddress) throws InterruptedException {
		pause(3);
		String emailParsed[] = emailAddress.split("@");
		String url = "http://www.mailinator.com/inbox2.jsp?public_to=" + emailParsed[0];
	...
	public static void waitForElement(WebDriver driver, WebElement webelement) {
		(new WebDriverWait(driver, 3)).until(ExpectedConditions.visibilityOf(webelement));
	...
	public static void closeWindow(WebDriver driver) throws InterruptedException {
